...
public class TerminalOperationMain {
    static void main(String[] args) {
        ...
        System.out.println("Even Numbers1 : "+ evenNumbers1 );
        System.out.println();
        ...
        List<Integer> evenNumbers2 = numbers.stream()
                .filter(n -> n % 2 == 0)
                .toList();
        System.out.println("Even Numbers2 : "+ evenNumbers2 );
        System.out.println();
        ...
        Integer[] arr = numbers.stream()
                .filter(n -> n % 2 == 0)
                .toArray(Integer[]::new);
        System.out.println("Even Numbers arr : " + Arrays.toString(arr) );
        System.out.println();
        ...
        Integer any = numbers.stream()
                ...
                .findAny()
                .get();
        System.out.println("5보타 큰것중에 아무거나 하나: " + any);
        System.out.println();

        System.out.println("11. anyMatch - 조건을 만족하는 요소 존재 여부");
        boolean hasEven = numbers.stream()
                .anyMatch(n -> n % 2 == 0);
        System.out.println("짝수를 가지고 있는지: " + hasEven);
        System.out.println();

        System.out.println("12. allMatch - 모든 요소가 조건을 만족하는지? ");
        boolean isAllMatch = numbers.stream()
                .allMatch(n -> n > 0);
        System.out.println("모두 양수여? : " + isAllMatch);
        System.out.println();

        System.out.println("13. noneMatch - 만족하는 요소가 없나? ");
        boolean hasNoNegative = numbers.stream()
                .noneMatch(n -> n < 0);
        System.out.println("음수가 없냐 : " + hasNoNegative);
        System.out.println();
    }
}
